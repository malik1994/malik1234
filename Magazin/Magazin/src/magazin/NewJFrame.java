...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Продовольственный Магазин");

        jButton2.setFont(new java.awt.Font("Tahoma", 3, 11)); // NOI18N
        jButton2.setText("Товары");
  ...
  NewJFrame1 a= new NewJFrame1();
        a.setVisible(true);
        a.setDefaultCloseOperation(NewJFrame1.DISPOSE_ON_CLOSE);        // откр первую форму
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
     NewJFrame2 a= new NewJFrame2();
        a.setVisible(true);
        a.setDefaultCloseOperation(NewJFrame2.DISPOSE_ON_CLOSE);   // откр Вторую форму
